/* ============================================================
   ...
   ============================================================ */
const SEL_FRAGE = ".card-header.b.f-90.user-select-none"; // Element mit dem Fragetext
const SEL_OPTIONEN = ".table.table-striped.mb-0.f-80 label"; // alle Antwortmöglichkeiten
